...
public class Log {
	...
	private String time_uploadWarehouse;
	public int getId() {
		return id;
	}
	...
	public String getTime_uploadWarehouse() {
		return time_uploadWarehouse;
	}
	public void setTime_uploadWarehouse(String time_uploadWarehouse) {
		this.time_uploadWarehouse = time_uploadWarehouse;
	}
